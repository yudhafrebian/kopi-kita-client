...
const LocationSection = () => {
  return (
    <div className="py-8 md:py-20 px-8 md:px-28 bg-[#6F4E37] flex flex-col lg:flex-row md:justify-between lg:justify-around items-center">
      <div>
        <h2 className="text-3xl md:text-5xl font-bold font-playfair text-white">
          Kunjungi Kami
        </h2>
        <div className="flex flex-col md:flex-row lg:flex-col md:mb-8 lg:mb-0">
          <div className="flex gap-4 mt-8 font-poppins">
            <MapPin className="text-white" />
            <div className="text-white">
              <p className="font-semibold md:text-lg">Alamat</p>
              <p className="text-xs md:text-base w-full lg:w-[55%]">
                Jl. Sudirman No. 123 Jakarta Pusat, DKI Jakarta 10220
              </p>
            </div>
          </div>
          <div className="flex gap-4 mt-4 md:mt-8 font-poppins">
            <Clock className="text-white" />
            <div className="text-white">
              <p className="font-semibold md:text-lg">Jam Buka</p>
              <p className="text-xs md:text-base">Senin - Jumat: 07:00 - 22:00</p>
              <p className="text-xs md:text-base">Sabtu - Minggu: 08:00 - 23:00</p>
            </div>
          </div>
          <div className="flex gap-4 mt-4 md:mt-8 mb-8 md:mb-0 font-poppins">
            <Phone className="text-white" />
            <div className="text-white">
              <p className="font-semibold md:text-lg">Kontak</p>
              <p className="text-xs md:text-base">+62 21 1234 5678</p>
            </div>
          </div>
        </div>
      </div>
